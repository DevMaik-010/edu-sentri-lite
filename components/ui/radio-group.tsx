  ...
  return (
    ...
    >
      <RadioGroupPrimitive.Indicator
        ...
        className="relative flex items-center justify-center after:absolute after:top-1/2 after:left-1/2 after:size-2 after:-translate-x-1/2 after:-translate-y-1/2 after:rounded-full"
      >
        <Check
          className="text-primary-foreground absolute top-1/2 left-1/2 size-3 -translate-x-1/2 -translate-y-1/2"
          strokeWidth={3}
        />
      </RadioGroupPrimitive.Indicator>
    </RadioGroupPrimitive.Item>
